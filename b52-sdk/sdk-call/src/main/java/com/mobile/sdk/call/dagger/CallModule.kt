...
import com.mobile.sdk.call.data.http.ApiConverterFactory
import com.mobile.sdk.call.data.http.DataService
import com.mobile.sdk.call.data.http.HostSelectionInterceptor
...
@Module(includes = [CallBinder::class, SingletonScopeViewModelFactoryBinder::class])
class CallModule : DataModule {
